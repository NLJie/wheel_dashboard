/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/ssd/jenkins_iotsw/slave/workspace/Toolchain/build-gnu-riscv_4/./source/riscv/riscv-gcc/gcc/config/riscv/riscv.md'.  */
...
extern int p_register_operand (rtx, machine_mode);
...
{
  return c >= CONSTRAINT_e && c <= CONSTRAINT_Qmp;
}
...
{
  if (c >= CONSTRAINT_Wsa && c <= CONSTRAINT_Zf)
    return;
