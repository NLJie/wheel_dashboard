...
enum opt_code
{
  ...
  OPT_mdelete_vsetvl_v0p7 = 1617,            /* -mdelete-vsetvl-v0p7 */
  OPT_mdelete_vsetvl_zero = 1618,            /* -mdelete-vsetvl-zero */
  OPT_mdelete_vsetvl_zero_bbs = 1619,        /* -mdelete-vsetvl-zero-bbs */
  OPT_mdelete_vsetvl2 = 1620,                /* -mdelete-vsetvl2 */
  OPT_mdiv = 1621,                           /* -mdiv */
  OPT_mdup_loop_header = 1622,               /* -mdup-loop-header */
  OPT_mexpand_split_imm = 1623,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1624,               /* -mexplicit-relocs */
  OPT_mext = 1625,                           /* -mext */
  OPT_mfclass = 1626,                        /* -mfclass */
  OPT_mfdiv = 1627,                          /* -mfdiv */
  OPT_mfldr = 1628,                          /* -mfldr */
  OPT_mfmvhw32 = 1629,                       /* -mfmvhw32 */
  OPT_mfp16 = 1630,                          /* -mfp16 */
  OPT_mfwprop_vmov_v0p7 = 1631,              /* -mfwprop-vmov-v0p7 */
  OPT_mglibc = 1632,                         /* -mglibc */
  OPT_minline_atomics = 1633,                /* -minline-atomics */
  OPT_minvariant_as_constant = 1634,         /* -minvariant-as-constant */
  OPT_mipa_unhot_inline = 1635,              /* -mipa-unhot-inline */
  OPT_mipush = 1636,                         /* -mipush */
  OPT_misa_spec_ = 1637,                     /* -misa-spec= */
  OPT_miv_adjust_addr_cost = 1638,           /* -miv-adjust-addr-cost */
  OPT_mlcm_mcfg = 1639,                      /* -mlcm-mcfg */
  OPT_mldd = 1640,                           /* -mldd */
  OPT_mldi = 1641,                           /* -mldi */
  OPT_mldr = 1642,                           /* -mldr */
  OPT_mload_merging = 1643,                  /* -mload-merging */
  OPT_mmove_loop_vsetvl = 1644,              /* -mmove-loop-vsetvl */
  OPT_mmula = 1645,                          /* -mmula */
  OPT_mmusl = 1646,                          /* -mmusl */
  OPT_mplt = 1647,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1648,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1649,                         /* -mrelax */
  OPT_mrev = 1650,                           /* -mrev */
  OPT_mrevw = 1651,                          /* -mrevw */
  OPT_mriscv_attribute = 1652,               /* -mriscv-attribute */
  OPT_mriscv_fli_value_by_int = 1653,        /* -mriscv_fli_value_by_int */
  OPT_mrnreg_delete_noop_move = 1654,        /* -mrnreg-delete-noop-move */
  OPT_mrvv_vector_bits_ = 1655,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 1656,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1657,               /* -mshorten-memrefs */
  OPT_msignedness_cmpiv = 1658,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1659,             /* -msmall-data-limit= */
  OPT_msrri = 1660,                          /* -msrri */
  OPT_msrriw = 1661,                         /* -msrriw */
  OPT_mstrict_align = 1662,                  /* -mstrict-align */
  OPT_mthread_jumps1 = 1663,                 /* -mthread-jumps1 */
  OPT_mtune_ = 1664,                         /* -mtune= */
  OPT_muclibc = 1665,                        /* -muclibc */
  OPT_munaligned_libcall = 1666,             /* -munaligned-libcall */
  OPT_mxor_combine = 1667,                   /* -mxor-combine */
  OPT_n = 1668,                              /* -n */
  OPT_name_sort = 1669,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1670,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1671,              /* -no-integrated-cpp */
  OPT_no_pie = 1672,                         /* -no-pie */
  OPT_nocpp = 1673,                          /* -nocpp */
  OPT_nodefaultlibs = 1674,                  /* -nodefaultlibs */
  OPT_nolibc = 1675,                         /* -nolibc */
  OPT_nophoboslib = 1676,                    /* -nophoboslib */
  OPT_nostartfiles = 1677,                   /* -nostartfiles */
  OPT_nostdinc = 1678,                       /* -nostdinc */
  OPT_nostdinc__ = 1679,                     /* -nostdinc++ */
  OPT_nostdlib = 1680,                       /* -nostdlib */
  OPT_o = 1681,                              /* -o */
  OPT_objects = 1682,                        /* -objects */
  OPT_p = 1683,                              /* -p */
  OPT_pass_exit_codes = 1684,                /* -pass-exit-codes */
  /* OPT_pedantic = 1685, */                 /* -pedantic */
  OPT_pedantic_errors = 1686,                /* -pedantic-errors */
  OPT_pg = 1687,                             /* -pg */
  OPT_pie = 1688,                            /* -pie */
  OPT_pipe = 1689,                           /* -pipe */
  OPT_posix = 1690,                          /* -posix */
  OPT_print_file_name_ = 1691,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1692,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1693,          /* -print-multi-directory */
  OPT_print_multi_lib = 1694,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1695,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1696,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1697,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1698,               /* -print-prog-name= */
  OPT_print_search_dirs = 1699,              /* -print-search-dirs */
  OPT_print_sysroot = 1700,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1701,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1702,                    /* -print-value */
  OPT_profile = 1703,                        /* -profile */
  OPT_pthread = 1704,                        /* -pthread */
  OPT_quiet = 1705,                          /* -quiet */
  OPT_r = 1706,                              /* -r */
  OPT_rdynamic = 1707,                       /* -rdynamic */
  OPT_remap = 1708,                          /* -remap */
  OPT_reverse_sort = 1709,                   /* -reverse-sort */
  OPT_s = 1710,                              /* -s */
  OPT_save_temps = 1711,                     /* -save-temps */
  OPT_save_temps_ = 1712,                    /* -save-temps= */
  OPT_shared = 1713,                         /* -shared */
  OPT_shared_libgcc = 1714,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1715,               /* -shared-libphobos */
  OPT_size_sort = 1716,                      /* -size-sort */
  /* OPT_specs = 1717, */                    /* -specs */
  OPT_specs_ = 1718,                         /* -specs= */
  OPT_static = 1719,                         /* -static */
  OPT_static_libasan = 1720,                 /* -static-libasan */
  OPT_static_libgcc = 1721,                  /* -static-libgcc */
  OPT_static_libgfortran = 1722,             /* -static-libgfortran */
  OPT_static_libgo = 1723,                   /* -static-libgo */
  OPT_static_liblsan = 1724,                 /* -static-liblsan */
  OPT_static_libmpx = 1725,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1726,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1727,               /* -static-libphobos */
  OPT_static_libstdc__ = 1728,               /* -static-libstdc++ */
  OPT_static_libtsan = 1729,                 /* -static-libtsan */
  OPT_static_libubsan = 1730,                /* -static-libubsan */
  OPT_static_pie = 1731,                     /* -static-pie */
  /* OPT_std_c__03 = 1732, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1733, */                /* -std=c++0x */
  OPT_std_c__11 = 1734,                      /* -std=c++11 */
  OPT_std_c__14 = 1735,                      /* -std=c++14 */
  OPT_std_c__17 = 1736,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1737, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1738, */                /* -std=c++1z */
  OPT_std_c__20 = 1739,                      /* -std=c++20 */
  OPT_std_c__23 = 1740,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1741, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1742, */                /* -std=c++2b */
  OPT_std_c__98 = 1743,                      /* -std=c++98 */
  OPT_std_c11 = 1744,                        /* -std=c11 */
  OPT_std_c17 = 1745,                        /* -std=c17 */
  /* OPT_std_c18 = 1746, */                  /* -std=c18 */
  /* OPT_std_c1x = 1747, */                  /* -std=c1x */
  OPT_std_c2x = 1748,                        /* -std=c2x */
  /* OPT_std_c89 = 1749, */                  /* -std=c89 */
  OPT_std_c90 = 1750,                        /* -std=c90 */
  OPT_std_c99 = 1751,                        /* -std=c99 */
  /* OPT_std_c9x = 1752, */                  /* -std=c9x */
  OPT_std_f2003 = 1753,                      /* -std=f2003 */
  OPT_std_f2008 = 1754,                      /* -std=f2008 */
  OPT_std_f2008ts = 1755,                    /* -std=f2008ts */
  OPT_std_f2018 = 1756,                      /* -std=f2018 */
  OPT_std_f95 = 1757,                        /* -std=f95 */
  OPT_std_gnu = 1758,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1759, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1760, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1761,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1762,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1763,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1764, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1765, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1766,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1767,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1768, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1769, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1770,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1771,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1772,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1773, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1774, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1775,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1776, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1777,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1778,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1779, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1780, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1781,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1782, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1783, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1784, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1785, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1786, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1787,                     /* -std=legacy */
  OPT_symbol_ = 1788,                        /* -symbol= */
  OPT_symbolic = 1789,                       /* -symbolic */
  OPT_t = 1790,                              /* -t */
  OPT_time = 1791,                           /* -time */
  OPT_time_ = 1792,                          /* -time= */
  OPT_traditional = 1793,                    /* -traditional */
  OPT_traditional_cpp = 1794,                /* -traditional-cpp */
  OPT_tree_stats = 1795,                     /* -tree-stats */
  OPT_trigraphs = 1796,                      /* -trigraphs */
  OPT_type_stats = 1797,                     /* -type-stats */
  OPT_u = 1798,                              /* -u */
  OPT_undef = 1799,                          /* -undef */
  OPT_v = 1800,                              /* -v */
  OPT_version = 1801,                        /* -version */
  OPT_w = 1802,                              /* -w */
  OPT_wrapper = 1803,                        /* -wrapper */
  OPT_x = 1804,                              /* -x */
  OPT_z = 1805,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
